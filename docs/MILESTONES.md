...
- M019: **In progress** on `codex/m019-common-actor`; [common Actor / multiple NPCs](milestones/M019_common_actor.md). Not merged to main.
...
| --- | --- | --- | --- |
| M019 | In progress on task branch | Common Actor ownership and multiple NPCs | `docs/milestones/M019_common_actor.md` |
