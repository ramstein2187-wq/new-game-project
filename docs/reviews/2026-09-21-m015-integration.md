...
- Publication: pending push and draft PR creation; update this checkpoint with the resulting link. Before merge, complete A manual checks, inspect the PR diff, refresh main and resolve any intervening document changes. Do not merge main or delete any branch as part of this preparation.
