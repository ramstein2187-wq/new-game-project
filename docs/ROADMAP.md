...
| World generation | Layered global geography prototype with variable world size, deterministic terrain/climate/hydrology, and separate landform/biome data | Complete on task branch | [M020](milestones/M020_world_generation_v2.md), `chat/worldgen-v2-prototype`; automated validation complete. Separate global layer; visual quality pass and region/local-map integration remain follow-ups. |
